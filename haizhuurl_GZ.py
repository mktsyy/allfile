...
with open("party.txt",'r') as f:
	...
	with open("new_GZ.html",'a+') as g:
		...
		for k in f.readlines():
			print k
			#python 代码换行
			url ="http://www.hizhu.com/Home/House/getsearchekey.html?city_code=001019001&keyword=%s" %  urllib2.quote(k.split("\n")[0])
			headers = {'User-Agent':'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36'}
			data = {'city_code':"001019001", 'keyword':urllib2.quote(k.split("\n")[0])}
			# print url
			...
			if partyid:
				##拼接小区搜索链接
				newurl = "http://www.hizhu.com/guangzhou/sqlist1/a0/b0/c0/d0/e0/f0/g0/h0/?" \
